...
public class ModFoods {
    ...
    public static final FoodProperties POPCORN = (new FoodProperties.Builder())
            .nutrition(2).saturationModifier(0.4f).fast().alwaysEdible().build();

    public static final FoodProperties CANDY_CORN = (new FoodProperties.Builder())
            .nutrition(2).saturationModifier(0.2f).fast().alwaysEdible().build();
    ...
    public static final FoodProperties ROTTEN_APPLE = (new FoodProperties.Builder()).nutrition(2).saturationModifier(0.1F)
            .effect(new MobEffectInstance(MobEffects.HUNGER, 600, 0), 0.2F).build();
