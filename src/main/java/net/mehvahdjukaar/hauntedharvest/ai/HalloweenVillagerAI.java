...
public class HalloweenVillagerAI {
    ...
    public static void onVillagerBrainInitialize(VillagerBrainEvent event) {
        ...
        if (Halloween.isHalloweenSeason(villager.level)) {
            ...
            if (villager.isBaby()) {
                ...
                event.scheduleActivity(ModRegistry.TRICK_OR_TREAT.get(), Halloween.TRICK_OR_TREAT_START, Halloween.TRICK_OR_TREAT_END);
