...
public class SplatteredEggRenderer extends EntityRenderer<SplatteredEggEntity> {
    ...
    public static final ResourceLocation TEXTURE = Halloween.res("textures/entity/egg/splattered_egg.png");
    public static final ResourceLocation TEXTURE_2 = Halloween.res("textures/entity/egg/splattered_egg_2.png");
